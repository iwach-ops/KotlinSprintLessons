...
const val GUESS_NUMBERS_RESPONSE = "Guessable numbers were:"
const val FROM_RANDOM = 0
const val TO_RANDOM = 42

fun main() {
    val guessRandomNumber1 = (FROM_RANDOM..TO_RANDOM).random()
    val guessRandomNumber2 = (FROM_RANDOM..TO_RANDOM).random()
    ...
    if ((inputNumber1 == guessRandomNumber1 ||
                inputNumber1 == guessRandomNumber2) &&
        (inputNumber2 == guessRandomNumber1 ||
                inputNumber2 == guessRandomNumber2)
    ) {
        println(
            """
            $GRAND_CONGRATULATION
            $GUESS_NUMBERS_RESPONSE $guessRandomNumber1 $guessRandomNumber2
        """.trimIndent()
        )
    } else if ((inputNumber1 == guessRandomNumber1 ||
                inputNumber1 == guessRandomNumber2) ||
        (inputNumber2 == guessRandomNumber1 ||
                inputNumber2 == guessRandomNumber2)
    ) {
